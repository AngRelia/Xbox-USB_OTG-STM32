...
// 引入你的串口打印函数声明
extern void Serial2_Printf(char *format, ...);
...
// 2. 修改：将所有 Log 宏重定向到 Serial2_Printf
#if (USBH_DEBUG_LEVEL > 0U)
#define  USBH_UsrLog(...)   do { \
                            Serial2_Printf(__VA_ARGS__); \
                            Serial2_Printf("\r\n"); \
} while (0)
#else
